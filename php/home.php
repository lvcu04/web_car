...
<body>
    <header class="header">
        <div class="navbar">
            ...
            <div class="box-car-head">
                <a class="account" href="#"><i class="fas fa-user"></i>Tài khoản</a>
    ...
    <div class="home-banner">
        <div class="slider">
            <div class="slides">
                <div class="slide">
                    <img src="https://static-cms-prod.vinfastauto.com/VF5-banner-3060x1406-min_1720268924.png" alt="" width="100%">
                </div>
                <div class="slide">
                    <img src="https://static-cms-prod.vinfastauto.com/3060x1406-min_1719894616.jpg" alt="" width="100%">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="brand">
            ...
            <path d="M87.75 16.0925C85.6853 22.6405 83.1316 23.9168 72.1017 23.9168C59.795 23.9168 59.0343 23.0012 62.3759 12.2358C65.6088 1.99769 67.2931 0 79.6813 0H91.2002L90.3037 2.83006C89.7875 2.83006 79.1652 2.83006 78.7848 2.83006C75.1444 2.83006 74.0577 3.69017 72.5092 8.15723H76.9103C77.1276 8.15723 77.3721 8.15723 77.6166 8.15723C78.0241 8.15723 78.4317 8.15723 78.812 8.15723H78.8392C88.2933 8.26821 89.7332 9.73873 87.75 16.0925ZM75.8779 11.015C75.6606 11.015 75.4704 11.015 75.2803 10.9873H71.6127C69.0318 19.311 68.8145 21.5029 72.8896 21.5029C76.3126 21.5029 77.3721 20.2821 78.6218 16.1202C79.9802 11.8197 79.5183 11.015 75.8779 11.015Z" fill="#3C3C3C"></path>
            <path d="M27.9821 0L12.4154 19.0058L9.10098 3.55145C8.63914 1.47052 6.87328 0 4.78141 0H0L5.16175 24H8.3403H13.5021L33.1439 0H27.9821Z" fill="#3C3C3C"></path>
            <path d="M48.7658 2.74682H62.9471L63.6806 0.0277443H45.2341C37.7088 0.0277443 31.1344 5.27168 29.3142 12.7353L26.5703 24H34.8291L37.6817 14.1225H53.4658L54.1993 11.4035H38.4695L38.7683 10.4046C40.0452 5.85433 44.1203 2.74682 48.7658 2.74682Z" fill="#3C3C3C"></path>
            </g>
            <defs>
            ...
            </g><g clip-path="url(#clip1_7952_5899)">
            <path d="M123.058 14.8168L122.214 17.9281H116.747L115.197 23.6372H107.755L109.316 17.9281H98.7578L99.498 15.2326L115.975 -0.418606H121.752L117.591 14.8168H123.058ZM112.431 6.53222L103.699 14.8168H110.166L112.431 6.53222Z" fill="#3C3C3C"></path>
            <path d="M24.5244 -0.404659L10.8818 18.7038L7.96615 3.1447C7.57582 1.07145 6.00972 -0.404659 4.20085 -0.404659H0L4.52455 23.7209H7.30211H11.8243L29.049 -0.404659H24.5244Z" fill="#3C3C3C"></path>
            <path d="M42.7157 2.33549H55.1421L55.7824 -0.404659L39.6168 -0.399079C33.0145 -0.396288 27.2618 4.87752 25.6695 12.3892L23.2656 23.7209H30.4892L32.9907 13.7788H46.8094L47.4616 11.0387H33.6785L33.9332 10.0258C35.0875 5.46629 38.66 2.33549 42.7157 2.33549Z" fill="#3C3C3C"></path>
            ...
            <path d="M28.578 0L12.6798 19.0058L9.2948 3.5237C8.82312 1.47052 7.01965 0 4.88324 0H0L5.27168 24H8.51792H13.7896L33.8497 0H28.578Z" fill="#3C3C3C"></path>
            <path d="M49.8049 2.71908H64.2882L65.0373 0H46.198C38.5124 0 31.798 5.24393 29.939 12.7075L27.1367 24H35.5714L38.4847 14.1225H54.6049L55.3541 11.4035H39.2893L39.5945 10.4046C40.8986 5.82659 45.0604 2.71908 49.8049 2.71908Z" fill="#3C3C3C"></path>
            <path d="M91.2019 0.0832367H83.0169H66.1476L65.3984 2.88555H80.9915L65.8424 23.9723H71.7245C73.1672 23.9723 74.5268 23.2786 75.3869 22.0855L89.1765 2.8578L91.2019 0.0832367Z" fill="#3C3C3C"></path>
            </g>
            <defs>
            ...
            <div class="slider">
                <div class="slides">
                    <div class="slide">
                        <img src="../img/vf-3_ 1715231397.webp" alt="VF 3" class="centered-image" id="slide_vf3">
                        <div class="infor-car">
                            <div class="line-car" >
